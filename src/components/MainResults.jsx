      ...
      <div className="p-[1.5rem] pt-0">
        ...
        <div className="cards flex flex-col md:flex-row gap-[2rem]  text-[#E7E7EB] md:flex-wrap">
          <div className="card md:w-[20rem] h-[12.5rem] md:h-[10rem] bg-[#1E213A] flex flex-col justify-center items-center">
            ...
            <div className="text-[#E7E7EB] text-[4rem] flex justify-center items-center">{Math.round(weatherInfo?.wind?.speed)||'4'}<span className='text-[2.25rem] text-center'>mph</span></div>
            <div className="flex gap-2"><img src={direction} alt=""  className='w-[1.8rem] rounded-full bg-[#88869D]'/> <span>wsw</span></div>
          </div>

          <div className="card md:w-[20rem] h-[12.5rem] md:h-[10rem] bg-[#1E213A] flex flex-col justify-center items-center">
            <h2>Humidity</h2>
            <div className="text-[#E7E7EB] text-[4rem] flex justify-center items-center">{weatherInfo?.main?.humidity||'83'}<span className='text-[2.25rem] text-center'>%</span></div>
          ...
          {/* progress bar */}
            <div className='bg-[#E7E7EB] h-[0.5rem] w-[15rem] rounded-[1rem]'>
              <div className={`bg-[#FFEC65] rounded-[1rem] h-[0.5rem]`} style={{width:`${weatherInfo?.main?.humidity}%`}}></div>
            </div>
          ...
          <div className="bg-[#1E213A] h-[10rem] md:w-[20rem] md:h-[8rem] flex flex-col justify-center items-center">
            ...
            <p className='text-[4rem]'>{weatherInfo?.visibility/1000 || 6.4}<span className='text-[2.25rem]'>miles</span></p>
          </div>
          <div className="bg-[#1E213A] h-[10rem] md:w-[20rem] md:h-[8rem] flex flex-col justify-center items-center">
            <h3 className='text-[#E7E7EB] text-[1rem]'>Air Pressure</h3>
            <p className='text-[4rem]'>{weatherInfo?.main?.pressure||98}<span className='text-[2.25rem]'>mb</span></p>
          </div>
        </div>
